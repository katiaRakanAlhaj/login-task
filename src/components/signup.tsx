...
function Signup() {
  const {
    ...
    resolver: yupResolver<TUser>(schema_signup),
    defaultValues: {
      name: '',
      email: '',
      password: '',
    ...
    <div className="flex">
      <div className="flex-1">
        <div className="container">
          <h1 className="text-green-600 text-center text-4xl mt-10">
            Sign in to Account
          </h1>
            ...
            <div className="flex justify-between mt-2">
              <div className="flex">
                <input
                  ...
                  id="checked-checkbox"
                  type="checkbox"
                  className="w-4 h-4 mt-3 text-green-600"
                />
                <p className="mt-2 mx-1 font-bold">remember me</p>
              </div>
              <div className="mt-2 font-bold">forget password</div>
            </div>
      ...
      <div className="flex-2">
        <div className="background">
          ...
          <button
            type="button"
            className="mt-6 w-36 h-12   font-medium text-white focus:outline-none bg-none rounded-full border border-gray-200  "
          >
            Sign Up
          </button>
        </div>
